...
/*   Updated: 2023/12/01 20:59:17 by minsepar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			print_node(t_list_node *node);
void			print_list_next(t_list *list);
void			print_list_prev(t_list *list);
...
void			ft_free_checker(void **zmem1, void **zmem2,
					void *mem1, void *mem2);
